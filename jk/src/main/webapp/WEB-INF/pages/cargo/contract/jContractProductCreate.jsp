...
<table id="ec_table" class="tableRegion" width="98%" >
	...
	<tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
		...
		<td>
			...
			<a href="delete.action?id=${o.id}&contractId=${o.contractId}" title="删除货物信息"><b>[删除]</b></a>&nbsp;&nbsp;&nbsp;
			<a href="${ctx}/cargo/extcproduct/tocreate.action?contractProductId=${o.id}" title="新增附件"><b>[附件]</b></a>
		</td>
	</tr>
	</c:forEach>
