...
public class PackingListServiceImpl implements PackingListService{
	...
	public void insert(PackingList packingList) {
		...
		packingList.setState(0);		//	初次增加时设为草稿状态
	...
	public String getDivData(String[] exportIds){
		...
		for(int i = 0; i < exportIds.length; i++){
			...
			sBuf.append("<input type=\"checkbox\" name=\"exportIds\" value=\"").append(exportIds[i]).append("\" checked/>");
			sBuf.append(export.getCustomerContract()).append("<br/>");
